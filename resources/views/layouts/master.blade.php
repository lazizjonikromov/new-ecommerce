								...
								<li class="menu-item" ><a title="Register or Login" href="register.html">Register</a></li> -->
                                    @if (Route::has('login'))
                                            @auth
                                                ...
                                                <!-- <li class="menu-item" ><a href="{{ url('admin/dashboard') }}" title="Register or Login">Dashboard</a></li> -->
												...
												@endif	
                                            @else
                                                <li class="menu-item" ><a href="{{ route('login') }}" title="Register or Login">Login</a></li>

                                                @if (Route::has('register'))
                                                    <li class="menu-item" ><a href="{{ route('register') }}" title="Register or Login">Register</a></li>
                                                @endif
                                            @endauth
                                    @endif
							...
							<div class="wrap-search-form">
								<div id="form-search-top" name="form-search-top">
									...
									<div class="wrap-list-cate">
										...
										<ul class="list-cate">
											<a href="{{url('/')}}"><li class="level-0">All Category</li></a>
											@foreach($categories as $category)
												<li class="level-1"><a href="{{url( '/category',['product'=>$category->id])}}">{{$category->name}}</a></li>
											@endforeach
										</ul>
									</div>
								</div>
							...
							@if (Route::has('login'))
                    			@auth
									<div class="wrap-icon-section wishlist">
										<a href="{{url('/')}}" class="link-direction">
									...
									<div class="wrap-icon-section minicart">
										<a href="{{url('/showcart')}}" class="link-direction">
								...
								@else
									<div class="wrap-icon-section wishlist">
										<a href="{{url('/login')}}" class="link-direction">
											<i class="fa fa-heart" aria-hidden="true"></i>
											<div class="left-info">
												<span class="index">0 item</span>
												<span class="title">Wishlist</span>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{url('/showcart')}}" class="link-term mercado-item-title">Cart</a>
								</li>
								<li class="menu-item">
